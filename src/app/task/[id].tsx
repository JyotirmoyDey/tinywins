...
export default function EditTask() {
  ...
  if (!task) return <SafeAreaView style={{ flex: 1, justifyContent: 'center', padding: 24, gap: 24 }}><Text>Task not found.</Text><Button label="Back home" onPress={() => router.replace('/')} /></SafeAreaView>;
